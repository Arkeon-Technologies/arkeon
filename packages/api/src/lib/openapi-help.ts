const FILTER_SYNTAX_BLOCK = [
  ...
  "#   kind            text       entity | commons | relationship | agent",
  "#   type            text       semantic type (book, person, etc.)",
  "#   ver             numeric    content version number",
  "#   owner_id        text       owner entity ULID",
  "#   commons_id      text       parent commons ULID",
  "#   view_access     text       public | private",
  "#   edit_access     text       public | collaborators | owner",
  "#   contribute_access text     public | contributors | owner",
