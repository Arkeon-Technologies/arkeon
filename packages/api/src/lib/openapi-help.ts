...
const FILTER_SYNTAX_BLOCK = [
  ...
  "#",
  "# SDKs: Pre-authenticated wrappers read ARKE_API_URL, ARKE_API_KEY, and ARKE_NETWORK_ID from env.",
  ...
  "#   Both auto-inject network_id and support paginate() for cursor-based iteration.",
  "",
  "## Filter Syntax",
