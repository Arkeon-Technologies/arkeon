...
const OPERATIONS: GeneratedOperation[] = [
  ...
  },
  {
    ...
    action: "post-reset",
    method: "POST",
    path: "/admin/queue/reset",
    summary: "Force-reset the invocation queue (aborts all running workers, cancels all pending)",
    description: "Force-reset the invocation queue (aborts all running workers, cancels all pending)",
    auth: "required",
    pathParams: [],
    queryParams: [],
    bodyFields: [],
  ...
  },
  {
    ...
    description: "Get worker invocation queue statistics",
    auth: "required",
    pathParams: [],
    queryParams: [],
    bodyFields: [],
  ...
  },
  {
    ...
    description: "Create a new entity, optionally adding it to a space and granting permissions",
    auth: "required",
    pathParams: [],
    queryParams: [],
  ...
  },
  {
    ...
    pathParams: [{ name: "id", description: "Entity ULID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [{ name: "note", description: "Optional version note for the merge", required: false, type: "string" }, { name: "property_strategy", description: "How to merge properties: keep_target, keep_source (default), or shallow_merge (source wins conflicts)", required: false, type: "string", enumValues: ["keep_target","keep_source","shallow_merge"] }, { name: "source_id", description: "Entity ULID to merge FROM (will be deleted)", required: true, type: "string" }, { name: "ver", description: "Expected current version (CAS token). Server increments ver on success.", required: true, type: "integer" }],
  },
  {
  ...
  },
  {
    ...
    method: "DELETE",
    path: "/knowledge/config/{id}",
    summary: "Delete an LLM configuration",
    description: "Delete an LLM configuration",
    auth: "optional",
    pathParams: [{ name: "id", description: "", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
    ...
    description: "Get knowledge extraction configuration",
    auth: "optional",
    pathParams: [],
    queryParams: [],
    bodyFields: [],
  },
  {
    ...
    group: "knowledge",
    action: "knowledge-job",
    method: "GET",
    path: "/knowledge/jobs/{id}",
    summary: "Get knowledge extraction job details with logs",
    description: "Get knowledge extraction job details with logs",
    auth: "optional",
    pathParams: [{ name: "id", description: "", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
    ...
    group: "knowledge",
    action: "knowledge-usage",
    method: "GET",
    path: "/knowledge/usage",
    summary: "Get knowledge extraction token usage",
    description: "Get knowledge extraction token usage",
    auth: "optional",
    pathParams: [],
    queryParams: [{ name: "from", description: "", required: false, type: "string" }, { name: "to", description: "", required: false, type: "string" }],
    bodyFields: [],
  },
  {
    operationId: "listKnowledgeJobs",
    group: "knowledge",
    action: "list-knowledge-jobs",
    method: "GET",
    path: "/knowledge/jobs",
    summary: "List knowledge extraction jobs",
    description: "List knowledge extraction jobs",
    auth: "optional",
    pathParams: [],
    queryParams: [{ name: "status", description: "", required: false, type: "string", enumValues: ["pending","processing","completed","failed"] }, { name: "entity_id", description: "", required: false, type: "string" }, { name: "limit", description: "", required: false, type: "string" }, { name: "offset", description: "", required: false, type: "string" }],
    bodyFields: [],
  },
  {
    ...
    description: "Manually trigger knowledge extraction for entities. Not needed after upload — content uploads are auto-ingested. Use this to re-extract or retry.",
    auth: "optional",
    pathParams: [],
    queryParams: [],
    bodyFields: [{ name: "entity_ids", description: "", required: true, type: "array" }],
  },
  {
    operationId: "updateKnowledgeConfig",
    group: "knowledge",
    action: "update-knowledge-config",
    method: "PUT",
    path: "/knowledge/config",
    summary: "Update knowledge extraction configuration",
    description: "Update knowledge extraction configuration",
    auth: "optional",
    pathParams: [],
    queryParams: [],
    bodyFields: [{ name: "extraction", description: "", required: false, type: "object" }, { name: "llm", description: "", required: false, type: "object" }],
  },
  {
  ...
  },
  {
    ...
    action: "batch",
    method: "GET",
    path: "/workers/batch/{batchId}",
    summary: "Get the status of a sequential batch",
    description: "Returns all invocations in the batch ordered by sequence, with aggregate progress.",
    auth: "required",
    pathParams: [{ name: "batchId", description: "Batch ID returned from invoke-batch", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
  ...
  },
  {
    ...
    action: "grant",
    method: "POST",
    path: "/workers/{id}/permissions",
    summary: "Grant invocation access on a worker (owner/admin only)",
    description: "Grant invocation access on a worker (owner/admin only)",
    auth: "required",
    pathParams: [{ name: "id", description: "Worker actor ULID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [{ name: "grantee_id", description: "Actor or group ULID to grant access to", required: true, type: "string" }, { name: "grantee_type", description: "", required: false, type: "string", enumValues: ["actor","group"] }, { name: "role", description: "", required: false, type: "string", enumValues: ["invoker"] }],
  },
  {
  ...
  },
  {
    ...
    description: "Queues a worker invocation. Returns 202 with an invocation ID by default. Pass ?wait=true to block until the invocation completes (returns 200 with full result). Use the 'then' array to chain sequential follow-up invocations — each step runs only after the previous one completes. With 'then', the response includes a batch_id for polling via GET /workers/batch/{batchId}.",
    auth: "required",
    pathParams: [{ name: "id", description: "Worker actor ULID", required: true, type: "string" }],
    queryParams: [{ name: "wait", description: "If 'true', block until invocation completes and return the full result. With 'then', waits for the entire pipeline.", required: false, type: "string" }],
    bodyFields: [{ name: "on_fail", description: "When a step fails: 'continue' runs the next step, 'cancel' cancels remaining. Only applies with 'then'.", required: false, type: "string", enumValues: ["continue","cancel"] }, { name: "prompt", description: "The task prompt for the worker", required: true, type: "string" }, { name: "store_log", description: "Override log storage (default: true, respects worker's log_level setting)", required: false, type: "boolean" }, { name: "then", description: "Follow-up steps executed sequentially after the initial invocation completes", required: false, type: "array" }],
  },
  {
  ...
  },
  {
    ...
    description: "List permissions on a worker",
    auth: "required",
    pathParams: [{ name: "id", description: "Worker actor ULID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
    ...
    action: "poll",
    method: "GET",
    path: "/workers/invocations/{invocationId}",
    summary: "Get a worker invocation by ID (poll for status)",
    description: "Retrieve the current state of a worker invocation. Use this to poll for completion after a 202 response from the invoke endpoint. Includes queue_position when status is 'queued'.",
    auth: "required",
    pathParams: [{ name: "invocationId", description: "Invocation ID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
    ...
    action: "revoke",
    method: "DELETE",
    path: "/workers/{id}/permissions/{granteeId}",
    summary: "Revoke invocation access from an actor or group",
    description: "Revoke invocation access from an actor or group",
    auth: "required",
    pathParams: [{ name: "id", description: "Worker actor ULID", required: true, type: "string" }, { name: "granteeId", description: "Grantee actor or group ID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
    ...
    action: "tree",
    method: "GET",
    path: "/workers/invocations/{invocationId}/tree",
    summary: "Get the full invocation tree from a root invocation",
    description: "Retrieves all invocations in the tree rooted at the given invocation ID using a recursive query. Returns a flat array ordered by depth then timestamp, with parent_invocation_id for client-side tree building.",
    auth: "required",
    pathParams: [{ name: "invocationId", description: "Root invocation ID", required: true, type: "string" }],
    queryParams: [],
    bodyFields: [],
  },
  {
